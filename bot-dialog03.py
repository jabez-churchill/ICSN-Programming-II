...
# DONE: Helper Function 1: Return a random item from a list, specified by dictionary key.
...
# DONE: Helper Function 2: Returns the right answer to a question passed in.
...
# DONE: Helper Function 3: Returns the category (dictionary key) that holds the message we passed in.
...
# DONE: Same as Helper Function 3, just much more "Python" style. 
...
# Use the functions we made so far in a MATCH-CASE STATEMENT, to return these:
def SpeakToThisBot2(messageReceived):
    # Find the context of the message
    # If greeting, return a random greeting.
    # If question, return the answer to that specific question.
    # If excuse, return "goodbye"
...
# Unit Test: 
# Don't change this, just run to test your functions above.
def UnitTest():
